                ...
                return (
                  <Card key={index} className="border-2 hover:shadow-lg transition-shadow">
                    <CardContent className="p-6">
                      ...
                      <Badge className={level.color + " mb-3 mx-auto block w-fit"}>{level.level}</Badge>
                      <p className="text-gray-700 text-sm leading-relaxed mb-4">{level.description}</p>
                      <div className="space-y-1">
                        <h4 className="font-semibold text-xs text-gray-800">Examples:</h4>
